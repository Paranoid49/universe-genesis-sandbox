  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        "src/ui/researchStorage.ts": { statements: 80, branches: 60, functions: 75, lines: 85 },
        "src/ui/useObservationWorkbench.ts": { statements: 80, branches: 70, functions: 80, lines: 85 },
        "src/ui/branchStorage.ts": { statements: 80, branches: 70, functions: 80, lines: 85 },
        "src/ui/useBranchLaboratory.ts": { statements: 80, branches: 70, functions: 80, lines: 85 },
        "src/components/ConstitutionCreator.tsx": { statements: 80, branches: 75, functions: 80, lines: 80 },
        "src/components/ObservationMetrics.tsx": { statements: 80, branches: 75, functions: 80, lines: 80 },
        "src/components/pages/AutonomousEntitiesPage.tsx": { statements: 80, branches: 75, functions: 80, lines: 80 },
        "src/components/RuntimeSession.tsx": { statements: 80, branches: 75, functions: 80, lines: 80 },
